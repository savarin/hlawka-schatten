...
The cyclic family is the triple `(-t, 1, 1), (1, -t, 1), (1, 1, -t)` for
`t > 0`. The ratio `cyclicRatio p t` encodes its deficit quotient; the
constant `cyclicConstant p` is the supremum over `t ∈ [1/2, 2]`.
